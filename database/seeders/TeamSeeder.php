...
class TeamSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $teams = [
            ...
            ['name' => 'New Orleans Pelicans', 'slug' => 'new-orleans-pelicans', 'external_id' => '19', 'division' => 'eastern_division', 'conference' => 'east', 'logo' => 'https://cdn.ssref.net/req/202603120/tlogo/bbr/NOH.png'],
